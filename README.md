# Respostas das questões teoricas

1 - As classes anemincas são otimas em casos de armazenamento de dados como o caso de entidades que 
	são a representação de um banco de daods na sistema.
	As classes ricas tem uma otimo exemplo ainda dentro do contexto do mvc que é as ViewModels que 
